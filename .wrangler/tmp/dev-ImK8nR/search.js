...
// .wrangler/tmp/bundle-q6OvIN/checked-fetch.js
...
// .wrangler/tmp/bundle-q6OvIN/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-q6OvIN/middleware-loader.entry.ts
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();

// .wrangler/tmp/bundle-q6OvIN/middleware-insertion-facade.js
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
  ...
  async fetch(request, env) {
    ...
    if (path.startsWith("/chat")) {
      try {
        ...
        const prompt = `
You are Blawby’s helpful AI support assistant. Answer the user's question concisely (2-3 sentences max), using only the information in the "Context" below. Format your response in Markdown (e.g., **bold**, lists, [links]).

IMPORTANT: Do NOT use any prior knowledge or training data—only the provided context. If the answer is not in the context, say you don't know and offer to create a support case.
