  ...
  return (
    <Button
      ...
      className={clsx(
        ...
        "bg-[var(--color-accent-400)] hover:bg-[var(--color-accent-500)] dark:bg-[var(--color-accent-500)] dark:hover:bg-[var(--color-accent-600)]",
        "before:absolute before:top-1/2 before:left-1/2 before:size-8 before:-translate-1/2 before:rounded-md before:z-0",
