  ...
  return (
    <div className="relative mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none dark:ring-white/10">
      <div className="p-8 sm:p-10 lg:flex-auto">
        ...
        <p className="body-text mt-6 text-base leading-7 font-bold text-gray-700 dark:text-gray-300">
          Cards and wallets - 2.9% + 30¢ per successful charge
        </p>
        <p className="body-text mt-2 text-base leading-7 text-gray-700 dark:text-gray-300">
        ...
        <ul
          role="list"
          className="body-text mt-8 grid grid-cols-1 gap-4 text-sm leading-6 sm:grid-cols-2 sm:gap-6"
        >
      ...
      <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
        <div className="rounded-2xl py-10 text-center ring-1 ring-gray-200 ring-inset lg:flex lg:flex-col lg:justify-center lg:py-16 dark:ring-white/10">
          <div className="mx-auto max-w-xs px-8">
            <p className="body-text text-base font-semibold text-gray-700 dark:text-gray-300">
            ...
            <p className="body-text mt-6 text-xs leading-5 text-gray-700 dark:text-gray-300">
              +Applicable fees{" "}
