  ...
  return (
    <div className="relative mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none dark:ring-white/10">
      <div className="p-8 sm:p-10 lg:flex-auto">
        ...
        <p className="mt-6 font-bold text-base leading-7 body-text text-gray-700 dark:text-gray-300">
          Cards and wallets - 2.9% + 30¢ per successful charge
        </p>
        <p className="mt-2 text-base leading-7 body-text text-gray-700 dark:text-gray-300">
        ...
        <div className="mt-10 flex items-center gap-x-4">
          <h4 className="flex-none text-sm font-semibold leading-6 text-gray-950 dark:text-white">
            What's included
          </h4>
        ...
        >
          {includedFeatures.map((feature) => (
            <li key={feature} className="flex gap-x-3 items-center">
              <CheckmarkIcon className="h-6 w-5 flex-none text-gray-950 dark:text-white" aria-hidden="true" />
      ...
      <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
        <div className="rounded-2xl py-10 text-center ring-1 ring-inset ring-gray-200 lg:flex lg:flex-col lg:justify-center lg:py-16 dark:ring-white/10">
          <div className="mx-auto max-w-xs px-8">
            ...
            <p className="mt-6 text-xs leading-5 body-text text-gray-700 dark:text-gray-300">
              +Applicable fees{' '}
              <span className="text-gray-950 dark:text-white"><a href="/pricing#pricingDetail">Learn More</a></span>
            </p>
          </div>
        </div>
      </div>
