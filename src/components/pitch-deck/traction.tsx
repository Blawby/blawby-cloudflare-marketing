  ...
  return (
    <section className="mb-16">
      ...
      <ul className="space-y-3 text-lg text-gray-700 dark:text-gray-300">
        <li>
          <strong>Beta client live:</strong>{" "}
          <a
            href="https://northcarolinalegalservices.org"
        ...
        <li>
          <strong>Revenue proof:</strong> $10k+ processed in first month
        </li>
        <li>
          <strong>Retention:</strong> NCLS continues subscription through
          development
        </li>
        <li>
          <strong>Roadmap:</strong> Matter Management live, Scheduling rolling
          out
        </li>
      </ul>
      ...
      <div className="mt-8">
        <h3
          id="client-management-interface"
