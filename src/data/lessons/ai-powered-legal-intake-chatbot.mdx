...
metaTitle: "AI Legal Intake Chatbot | Automated Intake"
desc: "Automate your law firm's intake process with Blawby's AI-powered chatbot. Capture qualified leads 24/7, process fees, and streamline client acquisition effortlessly."
...
secondaryKeywords:
  ["legal chatbot", "client acquisition automation", "intake automation"]
summary: "Learn how to use AI-powered chatbots for legal intake and client acquisition with Blawby."
schemaType: "Article"
noindex: false
---
...
[Learn more about payment processing](/payments/accepting-payments)  
[See how to manage client communications](/payments/clients)
...
1. **Ensure your Blawby account is active.** If you haven't completed the setup process yet, follow the [Getting Started guide](/guides/get-started) to set up your account, including verification and payment processing.
