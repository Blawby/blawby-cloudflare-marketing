...
const interviews = [
  ...
  },
  {
    ...
    intro: `Tom Harris, the host of the Blawby Podcast, shares his journey from questioning karate moves to embracing determinism, offering a unique perspective on free will, neuroscience, and the art of accepting life's predetermined path.`,
    video: {
      duration: 4210,
      thumbnail:
    ...
    chapters: [
      ...
      {
        start: 3018,
        title: "Practical Applications: Self-Blawbyion and Understanding",
      },
