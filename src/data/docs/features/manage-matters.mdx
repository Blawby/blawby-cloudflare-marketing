...
For the full structure (the unified view, the unbilled-summary → invoice flow, the client portal view, reassignment, status transitions), see [Matters Overview](/features/matters-overview).
