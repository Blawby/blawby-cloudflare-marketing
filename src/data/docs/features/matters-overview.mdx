...
desc: "How matters work in Blawby: Stop switching tabs and manage time tracking, billing, and client communication in one unified view."
...
This page is the map: how Blawby unifies the work into a single ledger of record, so you can stop switching between tools.

![Matter detail page with the unified view annotated ①–⑦: Overview, Work, Notes, Billing, Files, Activity, Settings.|1280x720](/media/docs/matters/walkthrough.png)
...
Either way, you land on the matter detail panel with the unified view across the top.

## The Unified Matter View

![Matter detail page with the unified view annotated ①–⑦: Overview, Work, Notes, Billing, Files, Activity, Settings.|1280x720](/media/docs/matters/tabs-annotated.png)
...
![Billing tab with the Ready to Invoice unbilled summary card and Create Invoice CTA above the invoice list.|1280x720](/media/docs/matters/billing-unbilled-summary.png)
