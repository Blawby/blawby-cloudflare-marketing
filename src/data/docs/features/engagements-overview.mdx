---
title: "Engagements Overview: Drafts, Fees, and Client Acceptance"
...
faq:
  - question: "What is an engagement in Blawby?"
    answer: "It's the formal agreement between your firm and a prospective client that confirms scope, fees, and conflict/jurisdiction status before work begins. Acceptance turns a qualified intake into an active matter."
  - question: "Who creates the engagement?"
    answer: "An attorney, after reviewing an accepted intake. Blawby pre-fills representation, fees, and status checks from intake and matter context, which the attorney edits and finalizes."
...
The engagement letter is the moment a qualified intake becomes a real client relationship. Blawby treats it as a structured object — not a free-text PDF — so the scope, fees, and conflict status can be edited, saved, and re-sent without retyping the whole letter.
...
![The Create Engagement dialog where Blawby pre-fills client, name, practice area, template, and fee structure before opening the full draft editor. Full video walkthrough coming soon.|1280x720](/media/docs/engagements/walkthrough.png)
...
- **Matter notes** — anything elevated: prior representation of an opposing party, statute-of-limitations exposure, regulatory complexity.
...
3. **Edit and review.** Pay particular attention to:
   ...
   - Status checks — are conflict and jurisdiction statuses clear?
...
- They scroll through representation, fees, and the firm's standard terms.
...
Mark conflict status accordingly, document the resolution (waiver, withdrawal, screening), and update notes before sending.
