...
![The public Blawby widget greeting visitors and inviting a consultation request — the entry point that opens the four-stage intake flow.|1280x720](/media/docs/intake/four-stage-flow.png)
...
Ready to convert more visitors into paying clients? [Start your setup.](https://ai.blawby.com/auth)
